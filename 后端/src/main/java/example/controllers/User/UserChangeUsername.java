...
public class UserChangeUsername extends HttpServlet {
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        String oldUsername = jsonObject.getString("oldUsername");
        ...
        responseBuilder.add("message", "changeUsername success");
